...
.post(authenticate.verifyUser, authenticate.verifyAdmin, (req, res, next) => { // adc a autenticação antes de executar a função, se falhar bloqueia-se o fluxo principal
